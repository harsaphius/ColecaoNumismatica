  ...
  <div class="container">
    <div class="flex-row gy-4 gy-lg-0 align-items-lg-center">
      <div class="col-12 col-lg-6" style="padding-left:80px">
          <asp:Chart ID="Chart1" runat="server" DataSourceID="SQLDSForChart" Width="550px" Height="550px">
              <Series>
                  <asp:Series Name="Series1" XValueMember="Moeda" YValueMembers="Valor" ChartType="Column" IsValueShownAsLabel="true" YValuesPerPoint="4"></asp:Series>
              </Series>
              <ChartAreas>
                  <asp:ChartArea Name="ChartArea1">
                      <AxisX Title="Código da Moeda"></AxisX>
                      <AxisY Title="Valor Atual da Moeda"></AxisY>
                  </asp:ChartArea>
              </ChartAreas>
          </asp:Chart>
          <asp:SqlDataSource ID="SQLDSForChart" runat="server" ConnectionString="<%$ ConnectionStrings:NumiCoinConnectionString %>" SelectCommand="SELECT TOP 10 NCS.ValorAtual AS Valor, NCM.CodMN AS Moeda FROM NumiCoinMoney AS NCM LEFT JOIN NumiCoinStateMN AS NCS ON NCM.CodMN = NCS.CodMN ORDER BY Valor DESC;"></asp:SqlDataSource></div>
      </div>
              ...
              <div class="col-12 col-sm-6">
                <div class="card border-0 border-bottom border-primary shadow-sm mb-4">
                  <div class="card-body text-center p-4 p-xxl-5">
                    ...
                    <p class="fs-5 mb-0 text-secondary">Total de Utilizadores</p>
                  </div>
                </div>
